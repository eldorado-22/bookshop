                ...
                <div className="footer">
                    ...
                    <nav className="footer--contact">
                        ...
                        <div className="footer--contact__ema-group">
                            <a href="tel: 777 777 777" className="footer--contact__ema-group--phone">+(996) 777 777 777</a>
                            <a href="Email" className="footer--contact__ema-group--email">motionweb@gmail.com</a>
                        </div>


                        <div className="footer--contact__social">
                            <a href="https://www.instagram.com/motion_web/"
                               className="footer--contact__social--instagram"><BsInstagram/></a>
                            <a href="https://www.facebook.com/"
                               className="footer--contact__social--facebook"><BsFacebook/></a>
                    ...
                    <nav className="footer--address">
                        ...
                        <a className="footer--address__map" href="https://www.google.com/maps/place/Motion+Web/@42.8797851,74.5833385,17z/data=!3m1!4b1!4m6!3m5!1s0x389ec9fc655f0bb9:0x20d210594faeb18!8m2!3d42.8797851!4d74.5855272!16s%2Fg%2F11nf_2wmrw">
